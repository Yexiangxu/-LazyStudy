...
object PluginsDeps {
    ...
    const val benmanesGradleVersionPlugin =
        "com.github.ben-manes:gradle-versions-plugin:${Versions.benmanesGradleVersionPlugin}"//用来检查所有依赖最新版本
...
object KotlinDeps {
    ...
    const val kotlinStdlib =
        "org.jetbrains.kotlin:kotlin-stdlib:${Versions.kotlinVersion}"//java转kotlin"
...
object ArouterDeps {
    ...
    const val arouterCompiler =
        "com.alibaba:arouter-compiler:${Versions.arouter}"//所有使用了arouter的model需要添加，否则跳转报错
}
...
object LifeCycleDeps {
    ...
    const val viewmodelKtx =
        "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.lifecycle}"//viewModelScope，用了该依赖不需用已被弃用的 androidx.lifecycle:lifecycle-extensions:2.2.0
}
